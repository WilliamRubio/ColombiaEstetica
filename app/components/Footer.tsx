      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-4 gap-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-blue-200/60 text-sm leading-relaxed max-w-sm mb-6">{t.description}</p>
            <div className="space-y-3">
              <a href="mailto:info@colombiaestetica.com" className="flex items-center gap-3 text-sm text-blue-200/70 hover:text-[#d4af6a] transition-colors">
                <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                info@colombiaestetica.com
              </a>
              <a href="https://wa.me/1XXXXXXXXXX" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm text-blue-200/70 hover:text-[#d4af6a] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {t.procedures.map((item) => (
                <li key={item}>
                  <a href="#procedures" className="text-sm text-blue-200/60 hover:text-[#d4af6a] transition-colors">{item}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {t.legal.map((item) => (
                <li key={item.label}>
                  <a href={item.href} className="text-sm text-blue-200/60 hover:text-[#d4af6a] transition-colors">{item.label}</a>
                </li>
              ))}
            </ul>
          </div>
