const benefits = [
  {
    ...
    description: "Our surgeons hold international certifications with over a decade of specialized experience in aesthetic procedures.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "Dedicated bilingual coordinators assist you before, during, and after your journey — from visa paperwork to hotel bookings.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "Start your journey from home with a secure video consultation with your surgeon before travelling to Colombia.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "Clear, itemized quotes — no hidden fees. You know exactly what you're paying for at every stage of the process.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "Every treatment plan is tailored to your anatomy, goals, and lifestyle — never a one-size-fits-all approach.",
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "Comprehensive post-operative care protocol and 24/7 medical follow-up during your recovery stay in Colombia.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 rounded-3xl p-8 grid grid-cols-2 lg:grid-cols-4 gap-8" style={{ background: "linear-gradient(135deg, #0d2d45 0%, #1a4a6b 100%)" }}>
          {[
            ...
            { value: "2,500+", label: "Successful Procedures" },
            { value: "40+", label: "Countries Served" },
            { value: "98%", label: "Patient Satisfaction" },
          ].map((stat) => (
            <div key={stat.label} className="text-center">
              <p className="text-3xl font-bold mb-1" style={{ color: "#d4af6a" }}>{stat.value}</p>
